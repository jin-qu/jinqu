...
describe("Jinqu should be able to use", () => {
    ...
    it("contains", () => {
        ...
        expect(items.asQueryable().contains({ id: 3 } as any, (i1, i2) => i1.id === i2.id)).to.be.true;
    });
    ...
    it("join", () => {
        ...
        expect(supCat).to.be.deep
            .equal([{ supplier: "ABC", category: "Cat01" }, { supplier: "QWE", category: "Cat02" }]);
    });
