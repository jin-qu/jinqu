...
export class PartArgument implements IPartArgument {
    ...
    public static identifier(value: Function | string, scopes: any[]) {
...
export class QueryPart implements IQueryPart {
    ...
    public static create(type: string, args?: PartArgument[], scopes?: any[]) {
        return new QueryPart(type, args, scopes);
    }

    public static aggregate<T, TAccumulate = any>(func: Func2<TAccumulate, T, TAccumulate>,
                                                  seed?: TAccumulate, scopes?: any[]) {
        return this.create(QueryFunc.aggregate, [identifier(func, scopes), literal(seed)], scopes);
    }

    public static all<T>(predicate?: Predicate<T>, scopes?: any[]) {
        return this.create(QueryFunc.all, [identifier(predicate, scopes)], scopes);
    }

    public static any<T>(predicate?: Predicate<T>, scopes?: any[]) {
        return this.create(QueryFunc.any, [identifier(predicate, scopes)], scopes);
    }

    public static average<T>(selector?: Func1<T, number>, scopes?: any[]) {
    ...
    public static contains<T>(item: T, comparer?: Func2<T, T, boolean>, scopes?: any[]) {
        return this.create(QueryFunc.contains, [literal(item), identifier(comparer, scopes)]);
    }

    public static count<T>(predicate?: Predicate<T>, scopes?: any[]) {
    ...
    public static distinct<T>(comparer?: Func2<T, T, boolean>, scopes?: any[]) {
    ...
    public static except<T>(other: T[], comparer?: Func2<T, T, boolean>, scopes?: any[]) {
        return this.create(QueryFunc.except, [literal(other), identifier(comparer, scopes)], scopes);
    }

    public static first<T>(predicate?: Predicate<T>, scopes?: any[]) {
        return this.create(QueryFunc.first, [identifier(predicate, scopes)], scopes);
    }

    public static firstOrDefault<T>(predicate?: Predicate<T>, scopes?: any[]) {
        return this.create(QueryFunc.firstOrDefault, [identifier(predicate, scopes)], scopes);
    }

    public static groupBy<T, TResult = any, TKey = any>(keySelector: Func1<T, TKey>,
                                                        elementSelector: Func2<TKey, T[], TResult>, scopes: any[]) {
        return this.create(
            QueryFunc.groupBy,
    ...
    public static groupJoin<T, TOther, TResult = any, TKey = any>(
    ...
    public static orderBy<T>(keySelector: Func1<T>, scopes: any[]) {
        return this.create(QueryFunc.orderBy, [identifier(keySelector, scopes)], scopes);
    }

    public static orderByDescending<T>(keySelector: Func1<T>, scopes: any[]) {
    ...
    public static skipWhile<T>(predicate: Predicate<T>, scopes: any[]) {
        return this.create(QueryFunc.skipWhile, [identifier(predicate, scopes)], scopes);
    }

    public static sum<T>(selector?: Func1<T, number>, scopes?: any[]) {
    ...
    public static takeWhile<T>(predicate: Predicate<T>, scopes: any[]) {
        return this.create(QueryFunc.takeWhile, [identifier(predicate, scopes)], scopes);
    }

    public static thenBy<T>(keySelector: Func1<T>, scopes: any[]) {
        return this.create(QueryFunc.thenBy, [identifier(keySelector, scopes)], scopes);
    }

    public static thenByDescending<T>(keySelector: Func1<T>, scopes: any[]) {
        return this.create(QueryFunc.thenByDescending, [identifier(keySelector, scopes)], scopes);
    }

    public static union<T>(other: T[], comparer?: Func2<T, T, boolean>, scopes?: any[]) {
        return this.create(QueryFunc.union, [literal(other), identifier(comparer, scopes)], scopes);
    }

    public static where<T>(predicate: Predicate<T>, scopes: any[]) {
        return this.create(QueryFunc.where, [identifier(predicate, scopes)], scopes);
    }

    public static zip<T, TOther, TResult = any>(other: TOther[], selector: Func2<T, TOther, TResult>, scopes: any[]) {
