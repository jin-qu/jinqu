...
export class Query<T = unknown, TExtra = object> implements IOrderedQuery<T, TExtra>, Iterable<T> {
    ...
    public aggregate<TAccumulate = number>(func: Func2<TAccumulate, T, TAccumulate>,
        seed?: TAccumulate, ...scopes: any[]): TAccumulate {
    ...
    public aggregateAsync<TAccumulate = number>(func: Func2<TAccumulate, T, TAccumulate>,
        seed?: TAccumulate, ...scopes: any[]): PromiseLike<TAccumulate> {
        return this.provider.executeAsync([...this.parts, QueryPart.aggregate(func, seed, scopes)]);
    }

    public all(predicate: Predicate<T>, ...scopes: any[]): Result<boolean, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.all(predicate, scopes)]);
    }

    public allAsync(predicate: Predicate<T>, ...scopes: any[]): PromiseLike<Result<boolean, TExtra>> {
        return this.provider.executeAsync([...this.parts, QueryPart.all(predicate, scopes)]);
    }

    public any(predicate?: Predicate<T>, ...scopes: any[]): Result<boolean, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.any(predicate, scopes)]);
    }

    public anyAsync(predicate?: Predicate<T>, ...scopes: any[]): PromiseLike<Result<boolean, TExtra>> {
        return this.provider.executeAsync([...this.parts, QueryPart.any(predicate, scopes)]);
    }

    public average(selector?: Func1<T, number>, ...scopes: any[]): Result<number, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.average(selector, scopes)]);
    }

    public averageAsync(selector?: Func1<T, number>, ...scopes: any[]): PromiseLike<Result<number, TExtra>> {
    ...
    public contains(item: T, comparer?: Func2<T, T, boolean>, ...scopes: any[]): Result<boolean, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.contains(item, comparer, scopes)]);
    }

    public containsAsync(item: T, comparer?: Func2<T, T, boolean>, ...scopes: any[]): PromiseLike<Result<boolean, TExtra>> {
        return this.provider.executeAsync([...this.parts, QueryPart.contains(item, comparer, scopes)]);
    }

    public count(predicate?: Predicate<T>, ...scopes: any[]): Result<number, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.count(predicate, scopes)]);
    }

    public countAsync(predicate?: Predicate<T>, ...scopes: any[]): PromiseLike<Result<number, TExtra>> {
    ...
    public distinct(comparer?: Func2<T, T, boolean>, ...scopes: any[]): IQuery<T, TExtra> {
    ...
    public except(other: T[], comparer?: Func2<T, T, boolean>, ...scopes: any[]): IQuery<T, TExtra> {
        return this.create(QueryPart.except(other, comparer, scopes));
    }

    public first(predicate?: Predicate<T>, ...scopes: any[]): Result<T, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.first(predicate, scopes)]);
    }

    public firstAsync(predicate?: Predicate<T>, ...scopes: any[]): PromiseLike<Result<T, TExtra>> {
        return this.provider.executeAsync([...this.parts, QueryPart.first(predicate, scopes)]);
    }

    public firstOrDefault(predicate?: Predicate<T>, ...scopes: any[]): Result<T, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.firstOrDefault(predicate, scopes)]);
    }

    public firstOrDefaultAsync(predicate?: Predicate<T>, ...scopes: any[]): PromiseLike<Result<T, TExtra>> {
    ...
    public groupBy<TKey = unknown, TResult = IGrouping<T, TKey>>(
        keySelector: Func1<T, TKey>, elementSelector?: Func2<TKey, T[], TResult>, ...scopes: any[])
        : IQuery<TResult, TExtra>;
    // eslint-disable-next-line no-dupe-class-members
    public groupBy<TKey = unknown, TResult = IGrouping<T, TKey>>(
        keySelector: Func1<T, TKey>, elementSelector?: Func2<TKey, T[], TResult>, ctor?: Ctor<TResult>, ...scopes: any[])
        : IQuery<TResult, TExtra> {
    ...
    public groupJoin<TOther, TKey = unknown, TResult = unknown>(
        ...
        selector: Func2<T, TOther[], TResult>, ...scopes: any[]): IQuery<TResult, TExtra>;
    // eslint-disable-next-line no-dupe-class-members
    public groupJoin<TOther, TKey = unknown, TResult = unknown>(
        other: TOther[], thisKey: Func1<T, TKey>, otherKey: Func1<TOther, TKey>,
        selector: Func2<T, TOther[], TResult>, ctor: Ctor<TResult>, ...scopes: any[]): IQuery<TResult, TExtra> {
    ...
    public intersect(other: T[], comparer?: Func2<T, T, boolean>, ...scopes: any[]): IQuery<T, TExtra> {
    ...
    public last(predicate?: Predicate<T>, ...scopes: any[]): Result<T, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.last(predicate, scopes)]);
    }

    public lastAsync(predicate?: Predicate<T>, ...scopes: any[]): PromiseLike<Result<T, TExtra>> {
        return this.provider.executeAsync([...this.parts, QueryPart.last(predicate, scopes)]);
    }

    public lastOrDefault(predicate?: Predicate<T>, ...scopes: any[]): Result<T, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.lastOrDefault(predicate, scopes)]);
    }

    public lastOrDefaultAsync(predicate?: Predicate<T>, ...scopes: any[]): PromiseLike<Result<T, TExtra>> {
        return this.provider.executeAsync([...this.parts, QueryPart.lastOrDefault(predicate, scopes)]);
    }

    public max<TResult = T>(selector?: Func1<T, TResult>, ...scopes: any[]): Result<TResult, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.max(selector, scopes)]);
    }

    public maxAsync<TResult = T>(selector?: Func1<T, TResult>, ...scopes: any[]): PromiseLike<Result<TResult, TExtra>> {
        return this.provider.executeAsync([...this.parts, QueryPart.max(selector, scopes)]);
    }

    public min<TResult = T>(selector?: Func1<T, TResult>, ...scopes: any[]): Result<TResult, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.min(selector, scopes)]);
    }

    public minAsync<TResult = T>(selector?: Func1<T, TResult>, ...scopes: any[]): PromiseLike<Result<TResult, TExtra>> {
    ...
    public orderBy(keySelector: Func1<T>, ...scopes: any[]): IOrderedQuery<T, TExtra> {
        return this.create(QueryPart.orderBy(keySelector, scopes)) as never;
    }

    public orderByDescending(keySelector: Func1<T>, ...scopes: any[]): IOrderedQuery<T, TExtra> {
    ...
    public select<TResult = unknown>(selector: Func1<T, TResult>, ...scopes: any[]): IQuery<TResult, TExtra>;
    // eslint-disable-next-line no-dupe-class-members
    public select<TResult = unknown>(selector: Func1<T, TResult>, ctor: Ctor<TResult>, ...scopes: any[]): IQuery<TResult, TExtra> {
        return this.fixCtorArg(s => QueryPart.select(selector, s), ctor, scopes) as never;
    }

    public selectMany<TResult>(selector: Func1<T, TResult[]>, ...scopes: any[]): IQuery<TResult, TExtra>;
    // eslint-disable-next-line no-dupe-class-members
    public selectMany<TResult>(selector: Func1<T, TResult[]>, ctor: Ctor<TResult>, ...scopes: any[]): IQuery<TResult, TExtra> {
        return this.fixCtorArg(s => QueryPart.selectMany(selector, s), ctor, scopes) as never;
    }

    public sequenceEqual(other: T[], comparer?: Func2<T, T, boolean>, ...scopes: any[]): Result<boolean, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.sequenceEqual(other, comparer, scopes)]);
    }

    public sequenceEqualAsync(other: T[], comparer?: Func2<T, T, boolean>, ...scopes: any[])
    ...
    public single(predicate?: Predicate<T>, ...scopes: any[]): Result<T, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.single(predicate, scopes)]);
    }

    public singleAsync(predicate?: Predicate<T>, ...scopes: any[]): PromiseLike<Result<T, TExtra>> {
        return this.provider.executeAsync([...this.parts, QueryPart.single(predicate, scopes)]);
    }

    public singleOrDefault(predicate?: Predicate<T>, ...scopes: any[]): Result<T, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.singleOrDefault(predicate, scopes)]);
    }

    public singleOrDefaultAsync(predicate?: Predicate<T>, ...scopes: any[]): PromiseLike<Result<T, TExtra>> {
    ...
    public skipWhile(predicate: Predicate<T>, ...scopes: any[]): IQuery<T, TExtra> {
        return this.create(QueryPart.skipWhile(predicate, scopes));
    }

    public sum(selector?: Func1<T, number>, ...scopes: any[]): Result<number, TExtra> {
        return this.provider.execute([...this.parts, QueryPart.sum(selector, scopes)]);
    }

    public sumAsync(selector?: Func1<T, number>, ...scopes: any[]): PromiseLike<Result<number, TExtra>> {
    ...
    public takeWhile(predicate: Predicate<T>, ...scopes: any[]): IQuery<T, TExtra> {
        return this.create(QueryPart.takeWhile(predicate, scopes));
    }

    public thenBy(keySelector: Func1<T>, ...scopes: any[]): IOrderedQuery<T, TExtra> {
        return this.create(QueryPart.thenBy(keySelector, scopes)) as never;
    }

    public thenByDescending(keySelector: Func1<T>, ...scopes: any[]): IOrderedQuery<T, TExtra> {
        return this.create(QueryPart.thenByDescending(keySelector, scopes)) as never;
    }

    public union(other: T[], comparer?: Func2<T, T, boolean>, ...scopes: any[]): IQuery<T, TExtra> {
        return this.create(QueryPart.union(other, comparer, scopes));
    }

    public where(predicate: Predicate<T>, ...scopes: any[]): IQuery<T, TExtra> {
        return this.create(QueryPart.where(predicate, scopes));
    }

    public zip<TOther, TResult = unknown>(other: TOther[], selector: Func2<T, TOther, TResult>, ...scopes: any[]): IQuery<TResult, TExtra>;
    // eslint-disable-next-line no-dupe-class-members
    public zip<TOther, TResult = unknown>(other: TOther[], selector: Func2<T, TOther, TResult>, ctor: Ctor<TResult>, ...scopes: any[]): IQuery<TResult, TExtra> {
    ...
    protected fixCtorArg(partCurry: (scopes: unknown[]) => IQueryPart, ctor: Ctor<unknown>, ...scopes: any[]) {
